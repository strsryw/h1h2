			...
			<tr>
				<td width="125">
					<script>
						...
						gridGroupUser.setHeaderText(["id", "Pabrikan", "Kode"]);
				...
				<td width="125">
					<script>
						...
						gridMenu.setHeaderText(["", "Group Id", "kategori Id", "Merk", "Kode"]);
						gridMenu.setColumnIndices([3, 4]);
						// gridGroupUser.setSelectionMode("single-row");
						...
						gridMenu.onCellEditEnded = function(text, col, row) {
							...
							kode = gridMenu.getCellValue(4, row);
				...
				<td width="125">
					<script>
						...
						gridJenis.setHeaderText(["", "kategoriId", "jenisId", "Type", "Kode"]);
						gridJenis.setColumnIndices([3, 4]);
						//gridGroupUser.setSelectionMode("single-row");
